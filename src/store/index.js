...
export default createStore({
  state: {
      tabSandwich:[{id:1,title:"Döner Kebab Poulet",prix: 4.5,url: "image"},
                      {id:2,title:"Döner Kebab Boeuf",prix: 4.5,url: "image"},
                      {id:3,title:"Yufka Poulet",prix: 4.5,url: "image"},
                      {id:4,title:"Döner Kebab Mixte",prix: 4.5,url: "image"},
                      {id:5,title:"Entier Poulet ou Boeuf",prix: 9,url: "image"},
                      {id:6,title:"Merguez",prix: 5,url: "image"},
                      {id:7,title:"Köfte",prix: 5,url: "image"},
                      {id:8,title:"Escalope",prix: 5.5,url: "image"},
                      {id:9,title:"Americain",prix: 5,url: "image"},
                      {id:10,title:"Yufka Boeuf",prix: 4.5,url: "image"},
                      {id:11,title:"Yufka Mixte",prix: 4.5,url: "image"},
                      {id:12,title:"Entier Mixte",prix: 9,url: "image"},
                      {id:13,title:"Tunisien",prix: 5.5,url: "image"},
                      {id:14,title:"Yufka Köfte",prix: 5,url: "image"},
                      {id:15,title:"Yufka Vegetarien",prix: 4.5,url: "image"},
                      {id:16,title:"Yufka Adana",prix: 5.5,url: "image"}
                      ],
      ...
      tabAssiette:[{id:1,title:"Assiètte Végétarienne",prix: 6,url: "image",description:"description"},
                      {id:2,title:"Assiètte Kebab Poulet",prix: 9,url: "image",description:"description"},
                      {id:3,title:"Assiètte Kebab Boeuf",prix: 9,url: "image",description:"description"},
                      {id:4,title:"Assiètte Kebab Mixte",prix: 9.5,url: "image",description:"description"},
                      {id:5,title:"Assiètte Merguez",prix: 9,url: "image",description:"description"},
                      {id:6,title:"Assiètte Steack Haché",prix: 9,url: "image",description:"description"},
                      {id:7,title:"Assiètte Köfte",prix: 10,url: "image",description:"description"},
                      {id:8,title:"Assiètte Adana",prix: 10,url: "image",description:"description"},
                      {id:9,title:"Assiètte Escalope",prix: 9,url: "image",description:"description"},
                      {id:10,title:"Assiètte Escalope à la crème",prix: 12,url: "image",description:"description"},
                      {id:11,title:"Assiètte Royale",prix: 14,url: "image",description:"description"},
                      {id:12,title:"Assiètte côtelette",prix: 15,url: "image",description:"description"},
                      {id:13,title:"Assiètte Faux-fillet",prix: 15,url: "image",description:"description"},
                      ],
